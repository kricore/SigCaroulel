...
<div id="sigProGalleriaWhite<?php echo $gal_id; ?>" class="sigProContainer sigProGalleriaWhiteContainer<?php echo $extraWrapperClass; ?>">
	...
	<div class="sigProGalleriaWhitePlaceholderContainer">
		<div class="sigProGalleriaWhitePlaceholder">
			<div class="galleria-main">
				...
				<div>
					<a data-rel="<?php echo $relName; ?>[gallery<?php echo $gal_id; ?>]" rel="<?php echo $relName; ?>[gallery<?php echo $gal_id; ?>]" href="<?php echo $photo->sourceImageFilePath; ?>" class="<?php echo $relName; ?> sigProGalleriaLink sigProGalleriaLinkEmpty" target="_blank">
						<img class="sigProGalleriaWhiteTargetImg" src="<?php echo $photo->sourceImageFilePath; ?>" alt="<?php echo JText::_('JW_SIGP_LABELS_08').' '.$photo->filename; ?>" />
					</a>
					<p class="sigProGalleriaWhiteTargetTitle"><?php echo $photo->captionTitle; ?></p>
				</div>
				<?php endforeach; ?>
			</div>
		</div>
	...
	<ul id="sigProId<?php echo $gal_id; ?>" class="galleria-nav sigProGalleria sigProGalleriaWhite<?php echo $extraWrapperClass; ?>">
		<?php foreach($gallery as $count=>$photo): ?>
